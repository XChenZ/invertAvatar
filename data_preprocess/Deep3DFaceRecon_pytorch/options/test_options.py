...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lm_folder', type=str, default='examples', help='folder for test images.')
        parser.add_argument('--save_folder', type=str, default='examples', help='folder for test images.')
